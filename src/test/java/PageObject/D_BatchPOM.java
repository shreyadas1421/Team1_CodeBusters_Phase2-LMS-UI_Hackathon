...
public class D_BatchPOM {
  ...
  //span[normalize-space()='Batch']
    ...
    @FindBy(xpath="/html/body/app-root/app-batch/p-dialog/div/div/div[2]/div[2]/input")
...
public String ProgramName = "First34"; 
//Batch cannot be created.

//@FindBy(xpath="//*[@id=\"programName\"]/div/div[3]/div/ul/p-dropdownitem[2]/li/span")
//private WebElement prgName ;


//@FindBy(xpath="/html/body/app-root/app-batch/p-toast/div");
//public Toast
 	...
 	public List<String> getTableHeaderList(List<WebElement> tableHeader) {
 	    ...
 	    return tableHeaderList;
 	 	...
 	 	System.out.println("Batch status");
	    	...
	    	//WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text()," + excelmap.get("SuccessAndFailedMessagePopup") + ")]")));
	    	WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(), '" + excelmap.get("SuccessAndFailedMessagePopup") + "')]")));
	    	...
	    	//assertTrue(messageElement.isDisplayed(), "Message 'Batch Created Successfully' is not displayed.");
	    	}

	    	if (elementText != null && (elementText.contains("Batch Created Successfully")))
	    	{
	    	 ...
	    	 if (excelmap.get("ErrorDesc") != null && !excelmap.get("ErrorDesc").isEmpty())
 	 	    {
	    		...
	    		try
	    		{
 	 	WebElement errorMessage = driver.findElement(By.xpath("//small[contains(@class, 'p-invalid') and contains(text(), '" + excelmap.get("ErrorDesc") + "')]"));
 	 	...
 	 	CloseAddNewPopUp.click();
  	 	 ...
  	 	 //  BatchNamePopupField.clear();
 	 	   ...
 	 	   //BatchDescriptionPopupField.clear();
 	 	    //ProgramNamePoupField.clear();
 	 	    //BatchNoOfClassesPopupField.clear();
...
// 	 	    }
 	 ...
 	 //p-toast//div[contains(@class, 'p-toast-detail')]
...
//EDIT BATCH
 	 	...
 	 	public void EditBatch(String sheetname, Integer rownum) {
 	 	   ...
 	 	   // WebElement batchName = driver.findElement(By.xpath("//td[contains(text(),'" + BatchNameForEdit +"'")); // Assuming "batch-name" is a class containing the batch name

//            // Check if this is the batch you're looking for
//            if (BatchNameForEdit.equals(batchName)) {
//                // Click on the edit icon associated with this batch
//               // batchName.findElement(By.xpath("//span[contains(text(),'edit')).click());   
//                		batchName.findElement(By.xpath(".//span[contains(text(),'edit')]")).click();
//
//                		// Stop the loop after finding the batch
//            }
	    	...
	    	//WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text()," + excelmap.get("SuccessAndFailedMessagePopup") + ")]")));
	    	WebElement EditmessageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(), '" + excelmap.get("SuccessAndFailedMessagePopup") + "')]")));


	 	 	  System.out.println("wait ended");

	 	 	assertEquals(EditmessageElement.isDisplayed(), true, "Success popup fouund");
	    	...
	    	System.out.println("else if wait " + excelmap.get("Error1DescBatchEdit"));
	    	 ...
	    	 if (excelmap.get("Error1DescBatchEdit") != null && !excelmap.get("Error1DescBatchEdit").isEmpty())
	 	    {
	    		...
	    		try
	    		{
	 	WebElement errorMessage = driver.findElement(By.xpath("//small[contains(@class, 'p-invalid') and contains(text(), '" + excelmap.get("Error1DescBatchEdit") + "')]"));
	 	System.out.println("error displayed " + errorMessage.isDisplayed());
