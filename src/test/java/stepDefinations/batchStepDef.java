...
public class batchStepDef extends D_BatchPOM{
	String oldbatchname;
	TestSetupManager testSetupManager;

	public batchStepDef(TestSetupManager testSetupManager) {
...
//	}
	...
	public void admin_is_on_dashboard_page_after_Login01() {
	...
	public void click_save_after_updating_the_batch_detail_fields_with_valid_values_and(String sheetname,
			Integer rownum) {
		log.info("@when edit " + sheetname + " " + rownum);
